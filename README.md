...
- **Submitted To / By layout** — choose how the two panels sit: **Stacked** (To above By, separated by a two-line gap — the default) or **Two Columns** (To on the left, By on the right, each centred in its half of the page). Each option has a mini-preview, the choice is saved with the cover, and both arrangements keep the section spacing of the original stacked design.
